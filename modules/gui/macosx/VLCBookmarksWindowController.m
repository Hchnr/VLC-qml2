...
- (IBAction)edit_ok:(id)sender
{
    ...
    if (componentCount == 1)
        pp_bookmarks[i]->i_time_offset = CLOCK_FREQ * ([[components firstObject] floatValue]);
    else if (componentCount == 2)
        pp_bookmarks[i]->i_time_offset = CLOCK_FREQ * ([[components firstObject] longLongValue] * 60 + [[components objectAtIndex:1] longLongValue]);
    else if (componentCount == 3)
        pp_bookmarks[i]->i_time_offset = CLOCK_FREQ * ([[components firstObject] longLongValue] * 3600 + [[components objectAtIndex:1] longLongValue] * 60 + [[components objectAtIndex:2] floatValue]);
    else {
