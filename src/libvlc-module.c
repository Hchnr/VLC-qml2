...
/* Input options */
    ...
    add_integer( "file-caching", mtime_to_ms(DEFAULT_PTS_DELAY),
                 CACHING_TEXT, CACHING_LONGTEXT, true )
        change_integer_range( 0, 60000 )
        change_safe()
    add_obsolete_integer( "vdr-caching" ) /* 2.0.0 */
    add_integer( "live-caching", mtime_to_ms(DEFAULT_PTS_DELAY),
    ...
    add_integer( "disc-caching", mtime_to_ms(DEFAULT_PTS_DELAY),
    ...
    add_integer( "network-caching", mtime_to_ms(1*CLOCK_FREQ),
    ...
    add_integer( "clock-jitter", ms_to_mtime(5), CLOCK_JITTER_TEXT,
