                            ...
                            int i_query, va_list args )
{
    ...
    switch( i_query )
    {
        ...
        case DEMUX_GET_LENGTH:
            ...
            {
                *va_arg( args, mtime_t * ) = INT64_C(8000000) * (i_end - i_start) / i_bitrate;
                return VLC_SUCCESS;
            }
            return VLC_EGENERIC;
        ...
        case DEMUX_GET_TIME:
            ...
            {
                *va_arg( args, mtime_t * ) = INT64_C(8000000) * (i_tell - i_start) / i_bitrate;
                return VLC_SUCCESS;
            }
            return VLC_EGENERIC;
        ...
        case DEMUX_SET_TIME:
            i64 = (mtime_t)va_arg( args, mtime_t );
