...
static mtime_t DecoderGetDisplayDate( decoder_t *p_dec, mtime_t system_now,
                                      mtime_t i_ts )
{
    struct decoder_owner *p_owner = dec_get_owner( p_dec );
...
static void OutputChangeDelay( decoder_t *p_dec, mtime_t delay )
{
    struct decoder_owner *p_owner = dec_get_owner( p_dec );
...
void input_DecoderChangeDelay( decoder_t *dec, mtime_t delay )
{
    struct decoder_owner *owner = dec_get_owner( dec );
